package cn.li.neoforge1211.entity;
...
import cn.li.mc1211.entity.hook.effect.ScriptedEffectHooks;
import cn.li.mc1211.entity.hook.marker.ScriptedMarkerHooks;
import cn.li.mc1211.entity.hook.ray.ScriptedRayHooks;
...
public final class ModEntities {
    ...
    public static final DeferredRegister<EntityType<?>> ENTITY_TYPES =
            DeferredRegister.create(Registries.ENTITY_TYPE, MyMod1211.MODID);
    ...
    public static DeferredHolder<EntityType<?>, EntityType<?>> register(String registryName, Supplier<? extends EntityType<?>> supplier) {
        DeferredHolder<EntityType<?>, EntityType<?>> entry =
            ENTITY_TYPES.register(registryName, () -> (EntityType<?>) supplier.get());
    ...
    public static <T extends Entity> EntityType<T> getEntityType(String registryName, Class<T> expectedClass) {
        DeferredHolder<EntityType<?>, EntityType<?>> entry = REGISTERED_ENTITY_TYPES.get(registryName);
