package cn.li.neoforge1211.client.render.item;

import cn.li.mc1211.client.render.item.ObjCompositeBakedModel;
 ...
 * <p>
 * Lives in the loader module for symmetry with Forge 1.20.1, where the no-arg
 * {@code ItemOverrides} constructor is only reachable outside vanilla because the loader
 * widens it to {@code protected}.
 */
