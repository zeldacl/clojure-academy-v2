(ns cn.li.neoforge1211.mod
  ...
  (:require [cn.li.neoforge1211.integration.bootstrap :as bootstrap]
    ...
    [cn.li.neoforge1211.registry.creative-tab :as creative-tab]
    [cn.li.neoforge1211.setup.common :as setup-common]
    [cn.li.neoforge1211.setup.lifecycle-init :as lifecycle-init]
...
;; MyMod1211 injects the mod event bus + ModContainer (no FMLJavaModLoadingContext).
