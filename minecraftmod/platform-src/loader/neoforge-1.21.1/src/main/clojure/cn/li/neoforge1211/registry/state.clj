...
(ns cn.li.neoforge1211.registry.state
...
(defn- safe-registry-object-get
	[^DeferredHolder registered-obj]
	(when (and registered-obj (.isBound registered-obj))
		(.get registered-obj)))
...
(defn get-registered-entity-type
	...
	(when-let [registered-obj (get-registered-entity-ro entity-id)]
		(safe-registry-object-get ^DeferredHolder registered-obj)))
