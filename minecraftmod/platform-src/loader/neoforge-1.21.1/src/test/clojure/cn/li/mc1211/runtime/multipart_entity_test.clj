(ns cn.li.mc1211.runtime.multipart-entity-test
...
(defn- with-parent-validation
  [valid-parent? f]
  (let [valid-parent-var (ns-resolve 'cn.li.mc1211.runtime.multipart-entity
                                     'valid-parent)
        validator-var (ns-resolve 'cn.li.mc1211.runtime.multipart-entity
