package cn.li.fabric1201.integration;
...
public final class JEIPluginWrapper implements IModPlugin {
    private static final ResourceLocation UID = new ResourceLocation(ModId.ID, "content_plugin");
    private final IModPlugin delegate;
    public JEIPluginWrapper() {
        try { ClojureInterop.requireNamespace("cn.li.fabric1201.integration.jei-impl"); IFn f = Clojure.var("cn.li.fabric1201.integration.jei-impl", "create-jei-plugin"); delegate = (IModPlugin) f.invoke(); }
