(ns cn.li.fabric262.client.obj-model-registration
  ...
  (:require [cn.li.mc262.client.render.obj-model-baking :as baking]
            [cn.li.mcmod.config :as modid]
            [cn.li.mcmod.util.log :as log])
  (:import [cn.li.fabric262.client.render.item ObjBakedModel ObjMeshLoader]
           [cn.li.mc262.client.render.item ObjCompositeBakedModel]
...
(defn- mod-rl
  ...
  (ResourceLocation. (str modid/mod-id) (str path)))
