package cn.li.neoforge262.integration;
...
public final class JEIPluginWrapper implements IModPlugin {
    ...
    public JEIPluginWrapper() {
        try { ClojureInterop.requireNamespace("cn.li.neoforge262.integration.jei-impl"); IFn f = Clojure.var("cn.li.neoforge262.integration.jei-impl", "create-jei-plugin"); delegate = (IModPlugin) f.invoke(); }
