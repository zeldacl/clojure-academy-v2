(ns cn.li.neoforge262.setup.registry-binding
  "Forge registry/config registration binding extracted from mod-bus orchestration."
  (:require [cn.li.neoforge262.config.bridge :as config-bridge]
            [cn.li.neoforgebase.integration.side :as side]
            [cn.li.neoforge262.setup.deferred-registries :as deferred-registries]
