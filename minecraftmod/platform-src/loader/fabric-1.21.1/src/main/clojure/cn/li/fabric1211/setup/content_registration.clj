(ns cn.li.fabric1211.setup.content-registration
  "Fabric content registration — thin Registry callbacks over
  cn.li.platform.registry.content-registration-core."
  (:require [cn.li.fabric1211.registry.fabric-dispatch :as fabric-dispatch]
  ...
  (:import [cn.li.fabric1211.entity FabricScriptedEntityAccess]
           [cn.li.fabric1211.shim FabricBootstrapHelper]
