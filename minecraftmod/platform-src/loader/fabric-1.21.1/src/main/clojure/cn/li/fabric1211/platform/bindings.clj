(ns cn.li.fabric1211.platform.bindings
  ...
  (:require [cn.li.mcmod.platform.position :as pos]
            ...
            [cn.li.fabric1211.mod :as fabric-mod])
...
(defn world-server-session-id
  [^Level level]
  (when-let [sid (cn.li.mc1211.runtime.RuntimeAccess/getWorldServerSessionId level)]
    [:server sid]))
...
(defn player-persistent-data
  ...
  (cn.li.fabric1211.runtime.FabricPlayerPersistentData/get player))
