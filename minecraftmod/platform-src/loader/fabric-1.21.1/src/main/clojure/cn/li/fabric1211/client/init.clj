(ns cn.li.fabric1211.client.init
  "Fabric 1.21.1 client-side initialization and registration"
  (:require [cn.li.mc1211.client.i18n :as i18n]
            ...
            [cn.li.fabric1211.adapter.gui-registry :as gui-registry]
            [cn.li.fabric1211.client.overlay-renderer :as overlay-renderer]
            ...
            [cn.li.fabric1211.client.key-mapping-adapter :as key-mapping-adapter]
  ...
  (:import [cn.li.fabric1211.client FabricClientRenderSetup]
           ...
           [cn.li.mc1211.client.render ScriptedBlockEntityBer]
           [cn.li.mc1211.client.render ModRenderTypes]
           [com.mojang.blaze3d.platform Window]
           [net.minecraft.world.entity.player Player]
           [cn.li.mc1211.client GuiGraphicsHelper]
           [cn.li.mc1211.client.effect ScriptedEffectSpawner]
