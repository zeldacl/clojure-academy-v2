(ns cn.li.fabric1211.integration.events.loot
  ...
  (:import [cn.li.fabric1211.loot FabricLootInjectionHelper]))
...
(defn handle-loot-table-modify
  ...
  (try
    ...
    (catch Throwable t
      (log/stacktrace "Error handling loot table modify event:" t)
      (.printStackTrace t))))
