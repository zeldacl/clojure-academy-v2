(ns cn.li.fabric1211.mod
  "Fabric 1.21.1 loader entrypoint.
  ...
  (:require [cn.li.platform.neutral.config :as modid]
            ...
            [cn.li.fabric1211.setup.event-wiring :as event-wiring]
            [cn.li.fabric1211.config.bridge :as config-bridge]
  ...
  (:import [cn.li.fabric1211.shim FabricBootstrapHelper]))
...
(defn start-fabric-mod!
  ...
  []
  (log/debug "Initializing AcademyCraft (Fabric 1.21.1) from Clojure...")
