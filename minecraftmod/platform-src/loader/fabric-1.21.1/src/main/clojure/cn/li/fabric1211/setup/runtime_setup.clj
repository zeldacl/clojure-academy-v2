(ns cn.li.fabric1211.setup.runtime-setup
  "Fabric runtime setup phase extracted from mod entry."
  (:require [cn.li.fabric1211.runtime.adapters.registry :as runtime-adapters-registry]
            [cn.li.fabricbase.runtime :as fabric-runtime]
            [cn.li.mcbase.runtime.adapter-registry :as adapter-registry]
            [cn.li.fabric1211.gui.init :as gui-init]
