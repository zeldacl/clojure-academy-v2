...
(defn register-screens! []
  (log/debug "Registering GUI screens for Fabric 1.21.1")
  (try
...
(defn init-client! []
  (log/debug "Initializing Fabric 1.21.1 client GUI system")
  (register-screens!)
  (log/debug "Fabric 1.21.1 client GUI system initialized"))
