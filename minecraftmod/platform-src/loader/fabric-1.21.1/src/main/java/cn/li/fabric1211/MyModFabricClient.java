...
public class MyModFabricClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        try {
            ClojureInterop.requireNamespace("cn.li.fabric1211.gui.init");
            IFn guiClientInit = Clojure.var("cn.li.fabric1211.gui.init", "init-client!");
            guiClientInit.invoke();

            ClojureInterop.requireNamespace("cn.li.fabric1211.client.init");
            IFn clientInit = Clojure.var("cn.li.fabric1211.client.init", "init-client");
            clientInit.invoke();
        } catch (Throwable t) {
