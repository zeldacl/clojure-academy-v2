...
public final class ScriptedRayCompositeRenderer<T extends Entity> extends EntityRenderer<T> {
    ...
    private static void emitLine(VertexConsumer lines, Matrix4f mat, float sideOffset, float length,
        ...
        lines.addVertex(mat, sideOffset, 0.0F, 0.0F)
                .setColor((startColor >> 16) & 255, (startColor >> 8) & 255, startColor & 255, alpha)
                .setNormal(0.0F, 1.0F, 0.0F)
                ;
        lines.addVertex(mat, sideOffset, 0.0F, -length)
                .setColor((endColor >> 16) & 255, (endColor >> 8) & 255, endColor & 255, alpha)
                .setNormal(0.0F, 1.0F, 0.0F)
                ;
    }
