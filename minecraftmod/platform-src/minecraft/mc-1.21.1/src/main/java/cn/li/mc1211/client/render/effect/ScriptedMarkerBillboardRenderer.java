...
public final class ScriptedMarkerBillboardRenderer<T extends Entity> extends EntityRenderer<T> {
    ...
    public void render(T entity, float entityYaw, float partialTick,
        ...
        try {
            ...
            vc.addVertex(mat, -size, 0.0F, 0.0F).setColor(255, g, b, a).setNormal(0.0F, 1.0F, 0.0F);
            vc.addVertex(mat, size, 0.0F, 0.0F).setColor(255, g, b, a).setNormal(0.0F, 1.0F, 0.0F);

            vc.addVertex(mat, 0.0F, -size, 0.0F).setColor(255, g, b, a).setNormal(0.0F, 1.0F, 0.0F);
            vc.addVertex(mat, 0.0F, size, 0.0F).setColor(255, g, b, a).setNormal(0.0F, 1.0F, 0.0F);
