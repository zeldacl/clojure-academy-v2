(ns cn.li.mc1211.entity.mob-logic-pipeline
  "Loader-neutral mob bundle compile/install pipeline (shared by Forge and Fabric)."
  (:require [cn.li.mc1211.entity.mob-logic-compile :as mob-compile]
            [cn.li.mcmod.entity.dsl :as edsl])
  (:import [cn.li.mc1211.entity ScriptedEntityLogicRegistry]
           [cn.li.mc1211.entity.logic MobLogicBundle]
