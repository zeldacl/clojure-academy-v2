(ns cn.li.mc1211.gui.slots.sync
  ...
  (:require [cn.li.mcmod.gui.registry :as gui-reg]
            ...
            [cn.li.mc1211.gui.menu.container :as ca]
            [cn.li.mc1211.gui.slots.common :as slots-common]
            [cn.li.mc1211.gui.slots.data-slot :as data-slot])
  (:import [cn.li.mc1211.gui CMenuBridge]
