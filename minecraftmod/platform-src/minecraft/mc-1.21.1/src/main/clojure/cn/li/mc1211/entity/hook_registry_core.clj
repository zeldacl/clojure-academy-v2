(ns cn.li.mc1211.entity.hook-registry-core
...
(def scripted-hook-specs
  ...
  {:effect {:entity-kind :scripted-effect
            ...
            :impl-key->hook-class {:tiered-arcs "cn.li.mc1211.entity.hook.effect.TieredArcsEffectHook"
                                   :owner-offset "cn.li.mc1211.entity.hook.effect.OwnerOffsetEffectHook"
                                   :owner-orbit "cn.li.mc1211.entity.hook.effect.OwnerOrbitEffectHook"
                                   :noop "cn.li.mc1211.entity.hook.effect.NoopEffectHook"
                                   :vertical-ballistic "cn.li.mc1211.entity.hook.effect.NoopEffectHook"}
   ...
   :ray {:entity-kind :scripted-ray
         ...
         :impl-key->hook-class {:owner-follow "cn.li.mc1211.entity.hook.ray.OwnerFollowRayHook"}
         :conflict-mode :by-hook-id
         :install-key :ray
   ...
   :marker {:entity-kind :scripted-marker
            ...
            :impl-key->hook-class {:owner-follow-marker "cn.li.mc1211.entity.hook.marker.OwnerFollowMarkerHook"}
