(ns cn.li.mc1211.gui.reactive.terminal-render
  "MC-specific rendering helpers for the terminal UI.
   ...
   See mc-1.20.1 terminal-render for upstream AuxGui / perspective notes.
   Screen host path renders orthographically; apply-perspective! kept for a
   future AuxGui-style draw pass."
