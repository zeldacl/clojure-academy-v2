(ns cn.li.mc1211.gui.slots.data-slot
  "Atom-backed Minecraft DataSlot implementations."
  (:require [cn.li.mcmod.gui.container.data-slot-codec :as codec])
  (:import [cn.li.mc1211.gui AtomBackedDataSlot AtomBackedDataSlot$Getter AtomBackedDataSlot$Setter]
...
(defn register-data-slots-on-menu!
  [^cn.li.mc1211.gui.CMenuBridge menu clj-container]
