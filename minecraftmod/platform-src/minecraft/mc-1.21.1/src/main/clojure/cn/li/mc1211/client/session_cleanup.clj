(ns cn.li.mc1211.client.session-cleanup
  "Shared client owner cleanup/orchestration for disconnects and server switches."
  (:require [cn.li.mc1211.client.effects.level-renderer :as level-renderer]
            [cn.li.mc1211.client.overlay.state :as overlay-state]
            [cn.li.mc1211.gui.reactive.overlay-host :as overlay-host]
