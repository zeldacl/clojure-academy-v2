...
(defn- install-version-hook-factories!
  ...
  (hook-core/install-hook-factories!
   {:effect {"cn.li.mc1211.entity.hook.effect.TieredArcsEffectHook"
             (reify java.util.function.Supplier (get [_] (cn.li.mc1211.entity.hook.effect.TieredArcsEffectHook.)))
             "cn.li.mc1211.entity.hook.effect.OwnerOrbitEffectHook"
             (reify java.util.function.Supplier (get [_] (cn.li.mc1211.entity.hook.effect.OwnerOrbitEffectHook.)))}}))

(defn register-all-hooks!
  []
  (hook-core/install-hook-class-prefix! "cn.li.mc1211")
