(ns cn.li.mc1211.entity.mob-logic-compile
  "Compile declarative mob hook maps into loader-neutral MobLogicBundle instances."
  (:import [cn.li.mc1211.entity.logic MobLogicBundle]
           [cn.li.mc1211.shim FnMobTickLogic FnMobHurtLogic FnMobDeathLogic FnMobLootLogic]))
