(ns cn.li.mc262.datagen.blockstate-provider-shell
  "Shared DataProvider shell for blockstate/block-model/item-model datagen.
  Uses PackOutput PathProviders; no ExistingFileHelper."
...
(defn- write-json!
  [^CachedOutput cached-output ^PackOutput$PathProvider path-provider ^Identifier id payload]
