(ns cn.li.mc262.runtime.adapter.entity-damage
  ...
  (:require [cn.li.mc262.runtime.entity-damage-core :as core]
            [cn.li.mc262.runtime.entity-query-core :as query-core]
...
(defn- pvp-blocked?
  "True when `entity` is a player and the content-registered PvP gate
   (mcmod.platform.entity-damage/install-pvp-gate!) currently disallows it â€?
