(ns cn.li.mc262.gui.slots.sync
  ...
  (:require [cn.li.mcmod.gui.registry :as gui-reg]
            ...
            [cn.li.mc262.gui.menu.container :as ca]
            [cn.li.mc262.gui.slots.common :as slots-common]
            [cn.li.mc262.gui.slots.data-slot :as data-slot])
