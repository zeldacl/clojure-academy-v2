(ns cn.li.mc262.entity.hook-registry-core
...
(defn register-hook-classes!
  "Register one scripted-hook kind's Java hook classes exactly once per process."
...
(def scripted-hook-specs
  ...
  {:effect {:entity-kind :scripted-effect
            ...
            :impl-key->hook-class {:tiered-arcs "cn.li.mc262.entity.hook.effect.TieredArcsEffectHook"
                                   :owner-offset "cn.li.mc262.entity.hook.effect.OwnerOffsetEffectHook"
                                   :owner-orbit "cn.li.mc262.entity.hook.effect.OwnerOrbitEffectHook"
                                   :noop "cn.li.mc262.entity.hook.effect.NoopEffectHook"
                                   :vertical-ballistic "cn.li.mc262.entity.hook.effect.NoopEffectHook"}
   ...
   :ray {:entity-kind :scripted-ray
         ...
         :impl-key->hook-class {:owner-follow "cn.li.mc262.entity.hook.ray.OwnerFollowRayHook"}
         :conflict-mode :by-hook-id
         :install-key :ray
