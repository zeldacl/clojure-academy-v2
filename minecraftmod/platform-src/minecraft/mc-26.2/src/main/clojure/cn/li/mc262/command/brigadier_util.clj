(ns cn.li.mc262.command.brigadier-util
...
(defn extract-all-arguments
  ...
  An omitted optional argument is not an error â€?the command ran at an
  earlier node â€?so it is skipped without the warning a genuinely failed
  extraction logs."
