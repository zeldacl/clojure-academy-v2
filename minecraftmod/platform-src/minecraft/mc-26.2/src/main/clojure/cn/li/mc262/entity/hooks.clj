...
(defn- install-version-hook-factories!
  ...
  (hook-core/install-hook-factories!
   {:effect {"cn.li.mc262.entity.hook.effect.TieredArcsEffectHook"
             (reify java.util.function.Supplier (get [_] (cn.li.mc262.entity.hook.effect.TieredArcsEffectHook.)))
             "cn.li.mc262.entity.hook.effect.OwnerOrbitEffectHook"
             (reify java.util.function.Supplier (get [_] (cn.li.mc262.entity.hook.effect.OwnerOrbitEffectHook.)))}}))
