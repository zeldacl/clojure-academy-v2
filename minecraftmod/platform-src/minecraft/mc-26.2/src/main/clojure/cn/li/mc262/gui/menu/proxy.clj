(ns cn.li.mc262.gui.menu.proxy
  ...
  (:require [cn.li.mcmod.gui.registry :as gui-reg]
            ...
            [cn.li.mc262.gui.slots.sync :as slots-sync]
            [cn.li.mcmod.hooks.core :as runtime-hooks]
            [cn.li.mcmod.runtime.owner :as runtime-owner]
            [cn.li.mcmod.util.log :as log])
  (:import [cn.li.mc262.bridge McAccess]
           [cn.li.mc262.shim DelegatingCMenuBridge]
           [cn.li.mc262.gui CMenuBridge]
...
(defn- finalize-menu-registration!
  ...
  (set! (.cljContainer ^cn.li.mc262.gui.CMenuBridge menu) clj-container)
  menu)
