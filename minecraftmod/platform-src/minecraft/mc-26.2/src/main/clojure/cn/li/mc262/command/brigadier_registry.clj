(ns cn.li.mc262.command.brigadier-registry
  ...
  (:require [cn.li.mcmod.command.metadata :as cmd-meta]
            ...
            [cn.li.mc262.command.brigadier-tree :as brig-tree]
            [cn.li.mc262.command.action-impls] ; Ensure action implementations are loaded
