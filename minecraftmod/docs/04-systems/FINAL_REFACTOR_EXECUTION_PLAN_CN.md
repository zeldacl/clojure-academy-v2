...
- Query/target：`target/raycast`, `target/raycast-fan`, `target/beam-trace`, `target/entities`, `target/blocks`, `target/entity-snapshot`, `target/item-held`, `target/saved-location`, `target/resolve-destination`, `target/block-placement`, `target/directional-destination-query`, `terrain/propagate` 及其 destination composite。
...
- Combat/action：`combat/damage`, `combat/status`, `combat/impulse`, `combat/charged-area-damage`, `combat/projectile-reflection-scan`, `combat/area-damage`, `combat/beam-strike`, `combat/break-budget`, `combat/impact-strike`, `combat/teleport-group`, `entity/*`, `motion/*`, `projectile/*`, `inventory/*`, `block/*`, `world/*`。
