...
| MD-013 | translation/datagen | data | Stable source-of-truth and reproducible datagen outputs. | done | `platform-src/minecraft/version/mc-1201/src/main/clojure/cn/li/mc1201/datagen/lang_data.clj`, `platform-src/minecraft/version/mc-1201/src/main/clojure/cn/li/mc1201/datagen/provider_manifest.clj`, `platform-src/loader/forge/src/main/clojure/cn/li/forge1201/registry/content_registration.clj`, `platform-src/loader/forge/build.gradle`, `ac/build.gradle`, `platform-src/loader/forge/run-data/logs/latest.log` | Forge `runData` now completes the real datagen provider pass after fixing the registry snapshot lookup and skipping unrelated `checkClojure` gates for `runData` invocations. |
