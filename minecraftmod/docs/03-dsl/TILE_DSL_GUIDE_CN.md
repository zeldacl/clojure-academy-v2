...
| `:capability-keys` | set of keyword | 濡?`#{:wireless-receiver :fluid-handler}`锛沨andler 宸ュ巶鐢?`platform.capability/declare-capability!` 娉ㄥ唽锛岀紪璇戣繘 `ITileCapabilityLogic` |
...
## 6. 缂栬瘧涓庡畨瑁咃紙`platform-src/minecraft/version/mc-1201`锛?
