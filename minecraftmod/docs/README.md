...
| **testing** | 测试范围说明 | [IMPLEMENTATION_SCOPE.md](testing/IMPLEMENTATION_SCOPE.md)、[MULTI_LOADER_VERIFICATION.md](testing/MULTI_LOADER_VERIFICATION.md) |
| **dev** | Agent / 工具链与构建验证手册 | [AGENT_AND_TOOLING.md](dev/AGENT_AND_TOOLING.md)、[BUILD_AND_VERIFY_PLAYBOOK.md](dev/BUILD_AND_VERIFY_PLAYBOOK.md)、[ADD_NEW_LOADER_OR_VERSION.md](dev/ADD_NEW_LOADER_OR_VERSION.md)、[PLATFORM_MODULE_TEMPLATE.md](dev/PLATFORM_MODULE_TEMPLATE.md)、[BUILD_CONVENTION_EXTRACTION_PLAN.md](dev/BUILD_CONVENTION_EXTRACTION_PLAN.md) |
...
- **新增 Loader / 版本接入手册**：[dev/ADD_NEW_LOADER_OR_VERSION.md](dev/ADD_NEW_LOADER_OR_VERSION.md)
- **平台模块模板**：[dev/PLATFORM_MODULE_TEMPLATE.md](dev/PLATFORM_MODULE_TEMPLATE.md)
...
- **AC 内部分层与稳定公开入口**：[AC_MODULE_LAYERING.md](02-architecture/AC_MODULE_LAYERING.md)
...
- **Wireless 架构契约与维护**：[WIRELESS_REFACTOR_CONTRACTS.md](05-wireless/WIRELESS_REFACTOR_CONTRACTS.md)、[WIRELESS_SYSTEM_MAINTENANCE.md](04-systems/WIRELESS_SYSTEM_MAINTENANCE.md)
...
- **数据终端（Terminal）**：[TERMINAL_SYSTEM_MAINTENANCE.md](04-systems/TERMINAL_SYSTEM_MAINTENANCE.md)
