...
- 把 `Forge 1.20.1` 的现有成功经验整理成可以复制到 `NeoForge` / `Fabric` / 新版本的设计模板。
...
4. [04-loader-lifecycle-map.md](04-loader-lifecycle-map.md) — Forge / NeoForge / Fabric 启动链。
...
- 当前四层架构方向正确，应继续坚持。
- 当前默认交付线是 `forge-1.20.1`；`fabric-1.20.1` 已纳入根构建并按 minimal maintenance（compile 基线）维护。
