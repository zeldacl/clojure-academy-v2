...
(deftest matrix-info-area-policy-four-state-test
  (testing "initialized + owner"
    (is (= {:show-init? false
           ...
           (gui/matrix-info-area-policy true true))))
  ...
  (testing "initialized + non-owner"
    (is (= {:show-init? false
           ...
           (gui/matrix-info-area-policy true false))))
  ...
  (testing "uninitialized + owner"
    (is (= {:show-init? true
            ...
            :editable-ssid? false
            :editable-password? false}
           (gui/matrix-info-area-policy false true))))
  ...
  (testing "uninitialized + non-owner"
    (is (= {:show-init? false
            ...
            :editable-ssid? false
            :editable-password? false}
           (gui/matrix-info-area-policy false false)))))
...
(deftest matrix-info-area-policy-safe-defaults-test
  (testing "non-boolean inputs still fail closed"
    (is (= {:show-init? false
            ...
            :editable-ssid? false
            :editable-password? false}
           (gui/matrix-info-area-policy nil nil)))
    (is (= {:show-init? false
            :show-noinit? false
            :editable-ssid? false
            :editable-password? false}
           (gui/matrix-info-area-policy :initialized? nil)))))
