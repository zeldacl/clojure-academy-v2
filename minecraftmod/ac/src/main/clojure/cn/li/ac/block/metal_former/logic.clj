(ns cn.li.ac.block.metal-former.logic
	"Metal Former business logic: schema, inventory, forming tick, GUI handler, container functions."
...
(defn former-tick-fn [level _block-pos _block-state be]
...
(defn open-former-gui! [{:keys [player world pos sneaking] :as _ctx}]
