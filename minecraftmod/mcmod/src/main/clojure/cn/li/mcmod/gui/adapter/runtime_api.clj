(ns cn.li.mcmod.gui.adapter.runtime-api
  "Unified runtime adapter API for GUI container/menu/screen operations.

   This namespace consolidates former fragmented wrapper namespaces:
   - container-registry
   - menu-registry
   - screen-factory"
