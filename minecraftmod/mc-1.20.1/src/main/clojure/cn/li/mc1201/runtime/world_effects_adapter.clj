(ns cn.li.mc1201.runtime.world-effects-adapter
  "Shared IWorldEffects adapter factory.

  Platform namespaces provide the server lookup plus the platform-specific
  entity/lightning/explosion APIs; this namespace owns the shared world-query
  orchestration."
