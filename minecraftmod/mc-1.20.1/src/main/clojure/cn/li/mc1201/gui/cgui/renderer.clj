            ...
            (when (and si tex-loc-0 tex-loc-1)
              (try
                ...
                (let [^PoseStack ps (.pose gg)
                      ...
                      ^Tesselator tess (Tesselator/getInstance)
                      ^BufferBuilder bb (.getBuilder tess)]
                  (RenderSystem/setShaderTexture 0 tex-loc-0)
                  (RenderSystem/setShaderTexture 1 tex-loc-1)
                  (.begin bb VertexFormat$Mode/QUADS DefaultVertexFormat/POSITION_TEX)
                  (.vertex bb pose-matrix x1 y2 0.0) (.uv 0.0 1.0) (.endVertex bb)
                  (.vertex bb pose-matrix x2 y2 0.0) (.uv 1.0 1.0) (.endVertex bb)
                  (.vertex bb pose-matrix x2 y1 0.0) (.uv 1.0 0.0) (.endVertex bb)
                  (.vertex bb pose-matrix x1 y1 0.0) (.uv 0.0 0.0) (.endVertex bb)
                  (BufferUploader/drawWithShader (.end bb)))
