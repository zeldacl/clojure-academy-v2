(ns cn.li.mc1201.runtime.entity-damage-adapter
  "Shared IEntityDamage adapter factory.

  Platform namespaces provide server lookup and entity lookup/application
  callbacks; this namespace owns the damage-flow orchestration."
...
(defn create-entity-damage
  ...
  (let [get-entity-by-uuid (or get-entity-by-uuid-fn query-core/get-entity-by-uuid)
        ...
        apply-hurt! (or apply-hurt-fn (fn [_entity _dmg-source _damage] nil))
